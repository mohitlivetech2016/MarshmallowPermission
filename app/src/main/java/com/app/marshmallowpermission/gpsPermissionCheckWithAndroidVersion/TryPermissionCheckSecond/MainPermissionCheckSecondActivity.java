package com.app.marshmallowpermission.gpsPermissionCheckWithAndroidVersion.TryPermissionCheckSecond;
...
public class MainPermissionCheckSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_permission_check_second);
